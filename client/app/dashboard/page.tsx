...
import { Send, Inbox, Key, Settings, HelpCircle, MessageCircle, Clock, Shield, ArrowRight, Activity, TrendingUp, Users } from 'lucide-react';
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-12">
          ...
          Privacy-first anonymous communication using stealth addresses and end-to-end encryption
        </p>
                    ...
                    <div className="p-3 bg-blue-500/20 rounded-lg group-hover:bg-blue-500/30 transition-colors">
                      <Send className="h-6 w-6 text-blue-400" />
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-300">Send anonymous encrypted messages</p>
                        </div>
                      ...
                      <Inbox className="h-6 w-6 text-green-400" />
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-300">
                            {messages.length > 0 ? `${messages.length} messages` : 'Check for messages'}
                  </p>
                </div>
                    <ArrowRight className="h-5 w-5 text-gray-400 group-hover:text-white transition-colors" />
                  </div>
              ...
              <CardContent>
                {!userKeys ? (
                  <EmptyState
                    ...
                    action={{
                      label: setupKeysMutation.isPending ? 'Setting up...' : 'Setup Stealth Keys',
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <StatusBadge status="success" text="Keys Generated" />
                        ...
                        <div className="bg-gray-800 rounded-lg p-4">
                          <h4 className="text-sm font-medium text-gray-200 mb-2">Your Meta-Address</h4>
                    ...
                    <div className="flex items-center gap-3">
                      <StatusBadge 
                        status={userRegistryStatus.isRegistered ? 'success' : 'warning'} 
                        text={userRegistryStatus.isRegistered ? 'Registered' : 'Not Registered'} 
                      />
                    </div>
                  </div>
                )}
              ...
              <CardContent>
                  ...
                  <div className="space-y-3">
                        {messages.slice(0, 3).map((message, index) => (
                          <div key={index} className="flex items-start gap-3 p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                            <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                            <div className="flex-1">
                              <p className="text-sm font-medium text-white">New Message</p>
                              <p className="text-xs text-gray-300 line-clamp-1">{message.content}</p>
